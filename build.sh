...
ldflags="\
-w -s \
-X 'github.com/gweffectx/safedav/internal/conf.BuiltAt=$builtAt' \
-X 'github.com/gweffectx/safedav/internal/conf.GoVersion=$goVersion' \
-X 'github.com/gweffectx/safedav/internal/conf.GitAuthor=$gitAuthor' \
-X 'github.com/gweffectx/safedav/internal/conf.GitCommit=$gitCommit' \
-X 'github.com/gweffectx/safedav/internal/conf.Version=$version' \
-X 'github.com/gweffectx/safedav/internal/conf.WebVersion=$webVersion' \
"
